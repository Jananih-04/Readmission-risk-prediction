...
model = pickle.load(open(r'D:\Readmission risk prediction\data\trained_ensemble_model.pkl', 'rb'))

# Load the dataset with Patient_IDs
df = pd.read_csv(r"D:\Readmission risk prediction\data\updated_dataset_with_ids.csv")
hf = pd.read_csv(r"D:\Readmission risk prediction\data\updated_dataset_with_ids.csv")
...
# Load the dataset with Patient_IDs
df4= pd.read_csv(r'D:\Readmission risk prediction\data\updated_dataset_with_ids.csv')
...
def upload_file_to_google_drive(file_path):
    ...
    folder_id = '1Dqs1aMdTRdO5qCC8EuYnPyUc_H_9p-pn'
...
def send_pdf_via_sms(direct_download_link, to_number):
    ...
    from_phone_number = 'your_from_phone_number'  # Replace with your Twilio phone number
...
model1 = pickle.load(open(r'D:\Readmission risk prediction\data\trained_ensemble_model.pkl', 'rb'))

# Load the dataset with Patient_IDs
df1 = pd.read_csv(r'D:\Readmission risk prediction\data\updated_dataset_with_ids.csv')
